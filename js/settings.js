...
function renderNotifications(container) {
  ...
  permissionButton.addEventListener('click', async () => {
    ...
    if (result === 'granted') {
      // Inscrever este aparelho no Web Push imediatamente após a permissão.
      const { ensurePushSubscription } = await import('./push-notifications.js');
