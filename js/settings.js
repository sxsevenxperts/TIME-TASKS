...
function renderNotifications(container) {
  ...
  container.innerHTML = `${header('Notificações', 'Alertas enquanto o aplicativo estiver aberto.')}<div class="settings-page-body"><div class="settings-card"><div class="setting-row"><div class="setting-copy"><strong>Notificações do navegador</strong><span>Permissão atual: ${permission}.</span></div><button id="request-notification-permission" class="btn-secondary" type="button">Solicitar permissão</button></div><div class="setting-row"><div class="setting-copy"><strong>Lembretes de eventos e tarefas</strong><span>Dispara no horário configurado.</span></div>${switchControl('eventNotifications',settings.eventNotifications,'Lembretes de eventos')}</div><div class="setting-row"><div class="setting-copy"><strong>Som do lembrete</strong><span>Reproduz o alerta sonoro dentro do app.</span></div>${switchControl('soundEnabled',settings.soundEnabled,'Som do lembrete')}</div><div class="setting-row"><div class="setting-copy"><strong>Testar som</strong><span>Valide o volume antes de depender do alerta.</span></div><button id="test-notification-sound" class="btn-secondary" type="button">Ouvir agora</button></div></div><div class="settings-card"><div class="setting-row"><div class="setting-copy"><strong>Versículos diários</strong><span>Mensagem bíblica sem repetição pela manhã e à tarde.</span></div>${switchControl('verseNotifications',settings.verseNotifications,'Versículos diários')}</div><div class="setting-row"><div class="setting-copy"><strong>Horário da manhã</strong></div><input class="form-input setting-control" type="time" data-setting-key="verseMorningTime" value="${settings.verseMorningTime}" /></div><div class="setting-row"><div class="setting-copy"><strong>Horário da tarde</strong></div><input class="form-input setting-control" type="time" data-setting-key="verseAfternoonTime" value="${settings.verseAfternoonTime}" /></div></div><p class="settings-note">Para alertas quando o navegador estiver totalmente fechado será necessário ativar Web Push e service worker na próxima camada de infraestrutura.</p></div>`;
