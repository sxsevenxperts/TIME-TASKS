...
-- ---------------------------------------------------------------------------
-- Triggers e central de notificações (Fase 6)
-- ---------------------------------------------------------------------------
...
-- A política "System can insert notifications" (with check true) permitia
-- escrita anônima em qualquer usuário; o worker do executor usará service_role.
